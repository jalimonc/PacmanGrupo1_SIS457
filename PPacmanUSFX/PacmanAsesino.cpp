...
//
//PacmanAsesino::PacmanAsesino(Tile* _tile, Texture* _texturaPacman, int _posicionX, int _posicionY, int _velocidadPatron) 
...
PacmanAsesino::PacmanAsesino(Tile* _tile, Texture* _texturaPacmanAsesino, int _posicionX, int _posicionY, int _velocidad) :
	Pacman(_tile, _texturaPacmanAsesino, _posicionX, _posicionY, _velocidad)
{
	texturaAnimacion = new TextureAnimation();
	texturaAnimacion->setTexture(_texturaPacmanAsesino);
